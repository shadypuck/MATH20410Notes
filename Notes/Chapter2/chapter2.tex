...
\begin{itemize}
    ...
    \item \marginnote{1/19:}Theorem: Let $U\subset\R^n$ be open, and let $f:U\to\R^m$ be a $C^2$ function. Then for any $i,j$,
    \begin{equation*}
...
\begin{itemize}
    \item \marginnote{1/21:}Intuition for the total derivative?
    \begin{itemize}
